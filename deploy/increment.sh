...
PLUGIN_CURRENT_VERSION=$(awk '/    Version/{print $NF}' Genoo_Elementor_Extension.php)
...
# - In main file
sed -i "" "s/${PLUGIN_CURRENT_VERSION}/${PLUGIN_NEXT_VERSION}/g" Genoo_Elementor_Extension.php
# - In versin file
